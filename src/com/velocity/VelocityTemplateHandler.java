...
public class VelocityTemplateHandler {
    public static void main(String[] args) {
        String directory = "D:\\Applications\\MarkitoTemplateProcessor\\src\\com\\velocity\\templates\\";
        ...
        Template templateObj = loaFileByPath(veEngine, template);
    ...
    private static Template loaFileByPath(VelocityEngine veEngine, String template) {
